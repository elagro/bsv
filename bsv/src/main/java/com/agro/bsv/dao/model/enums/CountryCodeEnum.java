...
public enum CountryCodeEnum
{
    ...
    private static final Map<String, CountryCodeEnum> alpha3Map = new HashMap<String, CountryCodeEnum>();
    private static final Map<Integer, CountryCodeEnum> numericMap = new HashMap<Integer, CountryCodeEnum>();


    static
    {
        for (CountryCodeEnum cc : values())
        {
    ...
    private static CountryCodeEnum getByAlpha2Code(String code)
    {
        try
        {
            return Enum.valueOf(CountryCodeEnum.class, code);
        }
    ...
    private static CountryCodeEnum getByAlpha3Code(String code)
    {
     ...
     *         A CountryCode instance, or null if not found.
     */
    public static CountryCodeEnum getByCode(int code)
    {
